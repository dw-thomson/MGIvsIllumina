...
WorkDir=${BaseDir}/nfDifferentialAbundance_GRCh38_ensembl_trimmed
OutDir=${BaseDir}/outs_nfDifferentialAbundance_GRCh38_ensembl_trimmed

cd ${WorkDir}
mkdir -p ${OutDir}

RNAseqOutDir='/homes/daniel.thomson/projects/MGIvsIllumina/nfRNAseq_GRCh38_ensembl_trimmed/nfcoreRNAseq-outs/star_salmon'
